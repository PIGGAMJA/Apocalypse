...
public class Gun : MonoBehaviour {
    ...
    public AudioClip[] shotClips; // 발사 소리
    ...
    private IEnumerator ShotEffect(Vector3 hitPosition) 
    {
        ...
        // 총격 소리 재생(PlayOneShot은 소리를 중첩하여 재생함)
        gunAudioPlayer.PlayOneShot(shotClips[Random.Range(0,shotClips.Length)]);

        // 선의 시작점은 총구의 위치, 끝점은 매개변수인 충돌 위치
        ...
        // 0.03초 동안 잠시 처리를 대기함. 대기하는 동안 총알 궤적이 켜진채로 유지됩니다.
